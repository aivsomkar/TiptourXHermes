...
final class AccessibilityTreeResolver: @unchecked Sendable {
    ...
    struct ResolvedElement {
        ...
        /// The raw AX element handle. Held here so AXPress (semantic
        /// click without grabbing the cursor) and direct attribute reads
        /// can target the element without re-walking the tree. CFTypeRef
        /// is bridged automatically by Swift so the retain/release dance
        /// is handled for us.
